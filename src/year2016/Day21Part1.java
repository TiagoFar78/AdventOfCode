        ...
        for (String instructionString : instructions) {
            ...
            switch (instruction[0]) {
                ...
                case "swap_letter":
                    ...
                    break;
                case "rotate_based":
                    s = rotateBased(s, instruction[5].charAt(0));
                    break;
                case "rotate":
                    s = rotate(s, Integer.parseInt(instruction[2]) * (instruction[1].equals("left") ? -1 : 1));
                    break;
                case "reverse":
                    s = reverse(s, Integer.parseInt(instruction[2]), Integer.parseInt(instruction[4]));
                    break;
                case "move":
                    s = move(s, Integer.parseInt(instruction[2]), Integer.parseInt(instruction[5]));
                    break;
            }
        }
