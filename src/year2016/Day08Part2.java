...
public class Day08Part2 extends Challenge {
    ...
    private String solve(List<int[]> operations) {
        ...
        System.out.println("Read the panel to get the solution, each letter is 5 charactes wide");
        ...
        return "Solution is written above";
    }
