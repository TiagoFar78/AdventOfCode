...
//				System.out.println("cena: " + currentModuleName);
...
//				printList(pulsePropagationComparator);
//				if (pulsePropagationLog.size() == 500)
//				break;
			}
//			if (buttonClicks > 0) {
//				break;
...
//			printList(pulsePropagationLog);
//			System.out.println("Comparator");
//			printList(pulsePropagationComparator);
//			System.out.println();
			
			if (buttonsClicksLog == buttonClicksComparator) {
//				System.out.println("Tento comparar os dois e teve: ");
